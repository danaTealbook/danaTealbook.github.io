            ...
            <section className="home" id="home">
                <div className="home-content">
                    ...
                    <SlideEffect inAnimation='animate__animated animate__fadeInLeft' outAnimation='animate__animated animate__fadeOutLeft'delay={0.6}>
                        <a className="btn" href="resume/Dana Kenzhaliyeva.pdf" download="Resume.pdf">Download CV</a>
                    </SlideEffect>
                    <SlideEffect inAnimation='animate__animated animate__fadeInLeft' outAnimation='animate__animated animate__fadeOutLeft'delay={0.8}>
                        <div className="home-sci">
                            <a href="https://www.linkedin.com/in/dana-dk/" target="_blank" rel="noopener noreferrer"><i className='bx bxl-linkedin' ></i></a>
                            <a href="https://github.com/danaTealbook" target="_blank" rel="noopener noreferrer"><i className='bx bxl-github' ></i></a>
                        </div>
                    </SlideEffect>
                </div>
